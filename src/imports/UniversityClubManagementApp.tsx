import svgPaths from "./svg-mox6u9zfpq";
import { imgGroup, imgGroup1, imgGroup2, imgGroup3, imgGroup4, imgGroup5 } from "./svg-jhx3c";
...
function Truss() {
  return (
    <div className="absolute h-[257px] left-[86px] overflow-clip top-[208px] w-[261px]" data-name="Truss 1">
      <div className="absolute flex inset-[27.03%_75.49%_48.49%_24.51%] items-center justify-center">
        <div className="flex-none h-px rotate-[90deg] w-[62.933px]">
          <div className="relative size-full" data-name="Vector">
            <div className="absolute inset-[-4.5px_0]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 62.9329 9">
                <path d="M0 4.5H62.9329" id="Vector" stroke="var(--stroke-0, #38B6FF)" strokeWidth="9" />
              </svg>
            </div>
          </div>
        </div>
      </div>
      <div className="absolute inset-[27.03%_12.11%_72.97%_10.11%]" data-name="Vector">
        <div className="absolute inset-[-4.5px_-2.22%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 212.02 9">
            <path d="M4.5 4.5H207.52" id="Vector" stroke="var(--stroke-0, #38B6FF)" strokeLinecap="round" strokeWidth="9" />
          </svg>
        </div>
      </div>
      <ClipPathGroup4 />
...
function Container() {
  return <div className="absolute h-[28px] left-[31px] top-[621px] w-[384px]" data-name="Container" />;
}
...
export default function UniversityClubManagementApp() {
  return (
    <div className="relative size-full" data-name="University Club Management App" style={{ backgroundImage: "linear-gradient(rgb(245, 241, 232) 0%, rgb(239, 233, 221) 50%, rgb(232, 228, 219) 100%), linear-gradient(90deg, rgb(245, 241, 232) 0%, rgb(245, 241, 232) 100%)" }}>
      <Truss />
      <Container />
      <div className="absolute h-[28px] left-[81px] top-[514px] w-[283px]" data-name="Component 5">
        <Icon />
        <p className="absolute font-['Inter:Semi_Bold','Noto_Sans_JP:Bold',sans-serif] font-semibold inset-0 leading-[28px] not-italic text-[#3d3d4e] text-[0px] text-center tracking-[-0.4395px]">
          <span className="text-[18px]">　　</span>
          <span className="text-[15px]">Googleアカウントを利用します</span>
        </p>
      </div>
      <p className="absolute font-['Inter:Semi_Bold','Noto_Sans_JP:Bold',sans-serif] font-semibold leading-[28px] left-[222.5px] not-italic text-[#3d3d4e] text-[18px] text-center top-[451px] tracking-[-0.4395px] translate-x-[-50%] w-[283px]">画面をタップして始める</p>
    </div>
  );
}